...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/editor/css/media.css">
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/editor/js/jquery.js" ></script>
...
<ul id='sidemenu'>
    <li id='tab-type'><a href='<?php echo site_url('index.php/uploads/');?>' class='current'>From Computer</a></li>
