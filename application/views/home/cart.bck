							    ...
							    <tbody>
									<tr class="cart_item">
										...
										<td class="product-thumbnail hidden-xs">
											<a href="#">
												<img width="100" height="150" src="<?=base_url('assets/template/')?>images/product/product-1.jpg" alt="Product-1"/>
											</a>
										</td>
										...
										<tr class="cart_item">
											...
											<td class="product-thumbnail hidden-xs">
												<a href="#">
													<img width="100" height="150" src="<?=base_url('assets/template/')?>images/product/product-3.jpg" alt="Product-3"/>
												</a>
											</td>
											<td class="product-name">
							...
							<div class="cart-collaterals">
								<div class="cart_totals">
									...
									<div class="wc-proceed-to-checkout">
										<a href="<?=base_url('beranda/checkout')?>" class="checkout-button button alt wc-forward">Proceed to Checkout</a>
									</div>
								</div>
