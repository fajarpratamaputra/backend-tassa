													...
													<div class="product-wrap">
														<div class="product-images">
															<div class="shop-loop-thumbnail">
                                                                <img width="300" height="350" src="<?=base_url('assets/template/')?>images/product/product-1.jpg" alt="Product-1"/>
                                                            </div>
													...
													<figcaption>
														<div class="shop-loop-product-info">
															<div class="info-title">
																<h3 class="product_title"><a href="<?=base_url('beranda/details/')?>">Cras rhoncus duis viverra</a></h3>
															</div>
															<div class="info-meta">
											...
											<div class="product-container">
												<figure>
													<div class="product-wrap">
														<div class="product-images">
															<div class="shop-loop-thumbnail">
                                                                <img width="300" height="350" src="<?=base_url('assets/template/')?>images/product/product-8.jpg" alt="Product-8"/>
                                                            </div>
                                                            <div class="yith-wcwl-add-to-wishlist">
                                                                <div class="yith-wcwl-add-button">
                                                                    <a href="#" class="add_to_wishlist">
