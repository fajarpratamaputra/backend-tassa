          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <!-- End Page Header -->
            <form action="<?=base_url('categories/insert');?>" enctype="multipart/form-data" method="post">
            <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                          <!-- <form> -->
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="category" placeholder="Product Name">
                            </div>
